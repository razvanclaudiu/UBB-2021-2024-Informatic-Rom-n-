...
void Teste::test_ordonare_nrInmatriculare()
{
	...
	//for (int i = 0;i <= 7;i++)
		//cout << testMasina.at(i).getNrInmatriculare() << endl;
...
void Teste::test_raport()
{
	...
	srv.adauga_srv("SB99ZCF", "Daimler", "GLE SUV", "tir");
	assert(srv.getAllMasina_srv().size() == 7);
	vector<Pereche> testmap = srv.raport_model_srv();
	assert(testmap.size() == 7);
	assert(testmap.at(0).first() == "Toyota Yariss" && testmap.at(0).second() == 1);
	assert(testmap.at(1).first() == "HR-V" && testmap.at(1).second() == 1);
	assert(testmap.at(2).first() == "i4 M50" && testmap.at(2).second() == 1);
	assert(testmap.at(3).first() == "Toyota Avalon" && testmap.at(3).second() == 1);
	assert(testmap.at(4).first() == "Civic Sedan" && testmap.at(4).second() == 1);
	assert(testmap.at(5).first() == "X2" && testmap.at(5).second() == 1);
	assert(testmap.at(6).first() == "GLE SUV" && testmap.at(6).second() == 1);
	...
	assert(testmap.at(4).first() == "Civic Sedan" && testmap.at(4).second() == 1);
	assert(testmap.at(5).first() == "X2" && testmap.at(5).second() == 1);
	assert(testmap.at(6).first() == "GLE SUV" && testmap.at(6).second() == 2);
}
