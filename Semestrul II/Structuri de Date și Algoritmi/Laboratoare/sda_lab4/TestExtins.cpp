...
{
	Dictionar d;
	vector<TCheie> testkeylst;
	d.adauga(1, 1);
	d.adauga(5, 3);
	d.adauga(7, 5);
	d.adauga(23, 6);
	d.adauga(-8, 9);
	testkeylst = d.multimeaCheilor();
	assert(testkeylst.size() == 5);
	assert(testkeylst[0] == 1);
	assert(testkeylst[1] == 5);
	assert(testkeylst[2] == 7);
	assert(testkeylst[3] == 23);
	assert(testkeylst[4] == -8);
	d.sterge(7);
	testkeylst = d.multimeaCheilor();
	assert(testkeylst.size() == 4);
	assert(testkeylst[0] == 1);
	assert(testkeylst[1] == 5);
	assert(testkeylst[2] == 23);
	assert(testkeylst[3] == -8);
	d.sterge(1);
	d.sterge(5);
	d.sterge(23);
	d.sterge(-8);
	testkeylst = d.multimeaCheilor();
	assert(testkeylst.size() == 0);
}
...
void testAllExtins() {
	testCreeaza();
	cout << "Test Creeaza Succes" << endl;
	testAdauga();
	cout << "Test Adauga Succes" << endl;
	testSterge();
	cout << "Test Sterge Succes" << endl;
	testIterator();
	cout << "Test Iterator Succes" << endl;
	testQuantity();
	cout << "Test Quantity Succes" << endl;
	testMultimeaCheilor();
	cout << "Test MultimeaCheilor Succes" << endl;
}
