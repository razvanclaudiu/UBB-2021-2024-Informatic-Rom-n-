...
{
	Multime m;
	assert(m.diferetaMaxMin() == -1);
	m.adauga(5);
	assert(m.diferetaMaxMin() == 0);
	m.adauga(16);
	assert(m.diferetaMaxMin() == 11);
	m.adauga(30);
	assert(m.diferetaMaxMin() == 25);
	m.adauga(0);
	assert(m.diferetaMaxMin() == 30);
	m.adauga(10000);
	assert(m.diferetaMaxMin() == 10000);
	m.adauga(-10000);
	assert(m.diferetaMaxMin() == 20000);
	m.sterge(-10000);
	assert(m.diferetaMaxMin() == 10000);
